...
{
    /// <inheritdoc />
    public partial class AddUpdateAtAndCreatedAtColumnsToRatingEloxd : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PosterUri = table.Column<string>(type: "character varying(2000)", maxLength: 2000, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MoviePersonId = table.Column<Guid>(type: "uuid", nullable: false),
                    MovieRoleId = table.Column<Guid>(type: "uuid", nullable: false),
                    CharacterName = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_MoviePersonRoles", x => new { x.MovieId, x.MoviePersonId, x.MovieRoleId });
                    table.ForeignKey(
                        name: "FK_MoviePersonRoles_MoviePeople_MoviePersonId",
                        column: x => x.MoviePersonId,
                        principalTable: "MoviePeople",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_MoviePersonRoles_MovieRoles_MovieRoleId",
                        column: x => x.MovieRoleId,
                        principalTable: "MovieRoles",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_MoviePersonRoles_Movies_MovieId",
                        column: x => x.MovieId,
                        principalTable: "Movies",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    MoviesId = table.Column<Guid>(type: "uuid", nullable: false),
                    ProductionCountriesId = table.Column<Guid>(type: "uuid", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_MovieCountries", x => new { x.MoviesId, x.ProductionCountriesId });
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_MovieCountries_ProductionCountries_ProductionCountriesId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MovieCountries_ProductionCountriesId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MoviePersonRoles_MoviePersonId",
                table: "MoviePersonRoles",
                column: "MoviePersonId");

            migrationBuilder.CreateIndex(
                name: "IX_MoviePersonRoles_MovieRoleId",
                table: "MoviePersonRoles",
                column: "MovieRoleId");
